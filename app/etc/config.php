...
return [
    'modules' => [
        ...
        'Bss_SocialLogin' => 1,
        'Compatibility_AmastyCheckoutMagentoPersistent' => 1,
        'Dolphin_DeleteAccount' => 1,
        'Entirem_ImportPriceM1' => 1,
        'GateSoftware_Amqp' => 1,
        'GateSoftware_AwsS3' => 1,
        'GateSoftware_BaseErpConnector' => 1,
        'GateSoftware_BasePimcoreConnector' => 1,
        'GateSoftware_Bestsellers' => 1,
        'GateSoftware_Catalog' => 1,
        'GateSoftware_CatalogInventory' => 1,
        'GateSoftware_Checkout' => 1,
        'Hyva_CmsTailwindJit' => 1,
        'GateSoftware_Validation' => 1,
        'GateSoftware_CouponsApi' => 1,
        'GateSoftware_DeleteAccount' => 1,
        'GateSoftware_Email' => 1,
        'GateSoftware_Feed' => 1,
        'GateSoftware_GA4' => 1,
        'GateSoftware_Gdpr' => 1,
        'Hyva_BssGeoIPAutoSwitchStore' => 1,
        'Hyva_ThemeFallback' => 1,
        'Jajuma_ImageOptimizerUltimate' => 1,
        'GateSoftware_InventoryErpConnector' => 1,
        'GateSoftware_InventorySync' => 1,
        'GateSoftware_Label' => 1,
        'Mirasvit_Core' => 1,
        'GateSoftware_Migration' => 1,
        'GateSoftware_MultiStoreViewPricing' => 1,
        'GateSoftware_MultiStoreViewPricingCatalogRule' => 1,
        'GateSoftware_MultiStoreViewPricingPriceIndexer' => 1,
        'GateSoftware_Omnibus' => 1,
        'GateSoftware_OrderSequence' => 1,
        'GateSoftware_SalesStatusMapping' => 1,
        'PayU_PaymentGateway' => 1,
        'GateSoftware_Paypal' => 1,
        'GateSoftware_Pimcore' => 1,
        'GateSoftware_PoisonPill' => 1,
        'GateSoftware_Stock' => 1,
        'GateSoftware_ProductLine' => 1,
        'GateSoftware_ProductStockAlert' => 1,
        'GateSoftware_PromoRules' => 1,
        'GateSoftware_Promotions' => 1,
        'GateSoftware_SalesErpConnector' => 1,
        'GateSoftware_Tax' => 1,
        'GateSoftware_Orders' => 1,
        'GateSoftware_Search' => 1,
        'GateSoftware_Sitemap' => 1,
        'GateSoftware_Price' => 1,
        'GateSoftware_StockCustomization' => 1,
        'GateSoftware_Store' => 1,
        'GateSoftware_StoreLocator' => 1,
        'GateSoftware_Swatches' => 1,
        'GateSoftware_Sales' => 1,
        'GateSoftware_Testsuite' => 1,
        'Trustedshops_EasyIntegration' => 1,
        'Geissweb_Euvat' => 1,
        'GateSoftware_VisualMerch' => 1,
        'Magefan_Community' => 1,
        'GateSoftware_GeoIPAutoSwitchStore' => 1,
        'Hyva_BssProductStockAlert' => 1,
        'Hyva_BssSocialLogin' => 1,
        'GateSoftware_CmsTailwindJit' => 1,
        'Amasty_GdprCookieHyva' => 1,
        'Hyva_DolphinDeleteAccount' => 1,
        'Hyva_Email' => 1,
        'Hyva_GeisswebEuvat' => 1,
        'Hyva_GraphqlTokens' => 1,
        'Hyva_GraphqlViewModel' => 1,
        'Hyva_JajumaImageOptimizerUltimate' => 1,
        ...
        'Mirasvit_Scroll' => 1,
        'Amasty_GdprHyva' => 1,
        'GateSoftware_HyvaTheme' => 1,
        'Jajuma_HyvaInlineCss' => 1,
        'GateSoftware_ImageOptimizerUltimate' => 1,
        ...
        'Mirasvit_Brand' => 1,
        'Hyva_MirasvitCacheWarmer' => 1,
        'GateSoftware_LayeredNavigation' => 1,
        ...
        'GateSoftware_TrustedShops' => 1,
        'GateSoftware_Configuration' => 1,
    ],
    'scopes' => [
        'websites' => [
            'admin' => [
